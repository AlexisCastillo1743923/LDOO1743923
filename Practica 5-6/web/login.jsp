					...
					<!-- Nav -->
						<nav id="nav">
								...
								<li><a href="Registro.jsp">REGISTRARSE</a></li>
                                                                <li class="current"><a href="login.jsp">ACCEDER</a></li>
							</ul>
											...
											<header>
												<h2>Iniciar Sesión</h2>
                                                                                            ...
                                                                                            <form class="login" onsubmit="return error();" action="Comp" method="POST">
                                                                                                <label>Usuario:</label>
                                                                                                <input id="username" type="text" name="usuario"/><br>
                                                                                                <label>Contraseña:</label>
                                                                                                <input id="contraseña" type="password" name="contraseña"/><br>

                                                                                                <input id="submit" type="submit" value="Iniciar Sesion">
                                                                                                <br>¿No estás Registrado? <a id="registrarse" href="login.jsp">Registrarse</a>
                                                                                            </form>
